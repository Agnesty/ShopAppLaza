...
extension SideViewController: SideMenuViewControllerDelegate {
...
extension UIViewController {
    ...
    func revealViewController() -> SideViewController? {
        var viewController: UIViewController? = self
        
        if viewController != nil && viewController is SideViewController {
            return viewController! as? SideViewController
        }
        while (!(viewController is SideViewController) && viewController?.parent != nil) {
            viewController = viewController?.parent
        }
        if viewController is SideViewController {
            return viewController as? SideViewController
        }
        return nil
    }
...
extension SideViewController: UIGestureRecognizerDelegate {
    ...
    @objc private func handlePanGesture(sender: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            // If user swipes left and the side menu is already expanded, enable dragging they collapsing the sidemenu)
